...
# parser.add_argument('--resume', default=r'D:\work\project\race\airway_docker\project\040.ckpt', type=str, metavar='PATH',help='path to latest checkpoint (default: none)')
...
parser.add_argument('--test-freq', default='1', type=int, metavar='S', help='testing frequency')
...
parser.add_argument('--stridet', default=[68, 68, 68], nargs="*", type=int, metavar='stride', help='split stride train')
parser.add_argument('--stridev', default=[68, 68, 68], nargs="*", type=int, metavar='stride', help='split stride val')
