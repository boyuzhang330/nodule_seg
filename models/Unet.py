...
class UNet3D(nn.Module):
    ...
    def __init__(self, in_channels=1, out_channels=1):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv3d(in_channels=self._in_channels, out_channels=32, kernel_size=3, stride=1, padding=0),
        ...
        self.conv4 = nn.Sequential(
            nn.Conv3d(in_channels=128, out_channels=32, kernel_size=3, stride=1, padding=0),
            nn.InstanceNorm3d(32),
            nn.ReLU(inplace=True),
        ...
        self.conv5 = nn.Sequential(
            nn.Conv3d(in_channels=64, out_channels=32, kernel_size=3, stride=1, padding=0),
            nn.InstanceNorm3d(32),
            nn.ReLU(inplace=True),
